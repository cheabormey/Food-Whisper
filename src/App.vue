<template>
  <div class="max-w-[1640px]">
    <div class="max-w-[1640px] mx-auto flex justify-between items-center p-2">
...
<h1 @click="closeMobileMenu" class="text-2xl sm:text-3xl lg:text-2xl px-6 cursor-pointer transition-transform transform hover:scale-105">
    <span class="font-bold text-orange-500">Food Whisper</span>
      ...
      <!-- search input -->
      <div class="hidden lg:flex items-center px-2 w-[200px] sm:w-[250px] bg-w-[300px]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
        ...
        <input
          class="bg-transparent p-2 w-full rounded-lg text-sm border-2 border-slate-400"
          type="text "
          name=""
          id=""
          placeholder="Search Foods rode"
        />
      </div>
      <!-- cart buttton -->
      <button class="flex items-center py-2 rounded-full px-5">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
...
<!-- ce -->
  ...
  <nav class="w-64 flex-shrink-0">
    <div class="flex-auto h-[100vh] bg-slate-100">
